...
const services = [
  {
    ...
    description: '',
    bullets: [
      'Χωριστά δίκτυα για προσωπικό, πελάτες & συστήματα (VLAN)',
      'Εγκατάσταση Access Points για πλήρη κάλυψη χωρίς νεκρές ζώνες',
      'Προτεραιοποίηση κρίσιμων συσκευών με QoS (ταμεία, κάμερες)',
      'Αναβάθμιση σε WiFi 6 / 6e για υψηλές ταχύτητες & πολλές συσκευές',
    ],
  },
  {
    icon: Wrench,
