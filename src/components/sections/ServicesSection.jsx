...
const services = [
  ...
  },
  {
    ...
    description: '',
    bullets: [
      'Εγκατάσταση & παραμετροποίηση νέου εξοπλισμού από την αρχή',
      'On-site επέμβαση όταν κάτι δεν πάει καλά — γρήγορα και αποτελεσματικά',
      'Εκπαίδευση προσωπικού για σωστή και ανεξάρτητη χρήση του συστήματος',
      'Απομακρυσμένη υποστήριξη για άμεση επίλυση χωρίς αναμονή',
  ...
  },
  {
    ...
    description: '',
    bullets: [
      'Εγκατάσταση & ρύθμιση Starlink για υψηλή ταχύτητα ακόμα και χωρίς οπτική ίνα',
      '4G/5G routers ως κύρια ή εφεδρική σύνδεση — ιδανικό για απομακρυσμένες τοποθεσίες',
      'Αυτόματη εναλλαγή (failover) με multi-WAN router — μηδέν downtime σε βλάβη γραμμής',
    ],
  },
  {
    icon: Shield,
  ...
  {
    icon: Zap,
    title: 'Εξασφάλιση Επιχειρησιακής Λειτουργίας με Προηγμένες Λύσεις',
    code: 'SVC-007',
    subtitle: 'Διασφαλίστε την αδιάλειπτη λειτουργία της επιχείρησής σας με τεχνολογία που δεν κάνει πίσω.',
    description: '',
    bullets: [
      'Σχεδιασμός & υλοποίηση λύσεων υψηλής διαθεσιμότητας (High Availability)',
  ...
  },
  {
    ...
    code: 'SVC-006',
    subtitle: 'Ένας αξιόπιστος τεχνικός πάντα στο πλευρό σας — χωρίς αγωνία, χωρίς καθυστέρηση.',
    description: '',
    bullets: [
