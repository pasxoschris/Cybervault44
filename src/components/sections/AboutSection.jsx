        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="font-rajdhani text-lg text-white/60 leading-relaxed mb-10">
              Αποστολή μας είναι να παρέχουμε στις επιχειρήσεις υψηλό επίπεδο ασφάλειας δικτύων, 
              δίνοντας ιδαίτερη βάση στην διαθεσιμότητα των δικτυακών υπηρεσιών  — με την 
