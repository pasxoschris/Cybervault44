...
import { Eye, Edit, Copy, Trash2, Mail, CheckCircle, XCircle } from 'lucide-react';
...
export default function OffersHistory({ onEdit }) {
  ...
  return (
    <div>
      {offers.length === 0 ? (
        <div className="text-center py-16 text-white/30 text-sm">Δεν υπάρχουν προσφορές ακόμα.</div>
      ) : (
