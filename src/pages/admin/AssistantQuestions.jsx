  ...
  return (
    <div className="min-h-screen bg-[#0E1235] cyber-grid pt-16">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <p className="text-white/50 text-sm mb-8 font-rajdhani">Διαχείριση των default ερωτήσεων ανά ενότητα — εμφανίζονται στον SpotlightPOS Assistant</p>
                              ...
                              <Draggable key={q.id} draggableId={q.id} index={i}>
                                {(prov, snapshot) => (
                                  <QuestionRow
                                    ...
                                    onCommitText={updateQuestion}
                                    onCommitCategory={updateCategory}
