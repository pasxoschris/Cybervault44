  ...
  return (
    <TutorialLayout title="Σύνδεση Χρήστη" subtitle="Πώς να συνδεθείς στην εφαρμογή">
      ...
      <InfoBox icon="⚠️" title="Προαπαιτούμενα" variant="warning">
        ...
        <p className="mt-2">Δεν είναι απαραίτητο να έχει δημιουργήσει κατάλογο/συνοδευτικά, τραπέζια ή εκτυπωτές για να συνδεθεί μια νέα συσκευή ή νέος χρήστης.</p>
      </InfoBox>
      ...
      <div className="flex gap-2">
        <button
          ...
          className={`flex-1 py-2.5 rounded-xl text-sm font-medium transition-all ${tab === "device" ? "bg-primary text-primary-foreground shadow" : "bg-secondary text-secondary-foreground hover:bg-secondary/80"}`}
        >
          📱 Σύνδεση από νέα συσκευή
        </button>
        <button
          onClick={() => setTab("user")}
          className={`flex-1 py-2.5 rounded-xl text-sm font-medium transition-all ${tab === "user" ? "bg-primary text-primary-foreground shadow" : "bg-secondary text-secondary-foreground hover:bg-secondary/80"}`}
        >
          👤 Σύνδεση νέου χρήστη
        </button>
      </div>
