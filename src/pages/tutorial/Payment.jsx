      ...
      {active === "card" && (
        <>
          ...
          <InfoBox icon="⚠️" title="Αν παγώσει η παραγγελία" variant="warning">
            Αν πληρωθείς με κάρτα αλλά η παραγγελία παγώσει, <strong>κράτα το εικονίδιο Κέρματα πατημένο για 10 δευτερόλεπτα</strong>. Θα εμφανιστεί μήνυμα επιλογής τρόπου πληρωμής για να ξεκλειδώσεις την παραγγελία.
          </InfoBox>
        </>
      )}
