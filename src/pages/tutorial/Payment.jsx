      ...
      {active === "card" && (
        <>
          ...
          <InfoBox icon="⚠️" title="Αν παγώσει η παραγγελία" variant="warning">
            Αν πληρωθείς με κάρτα αλλά η παραγγελία παγώσει, <strong>κράτα τα κέρματα πατημένα για 10 δευτερόλεπτα</strong>. Θα εμφανιστεί μήνυμα <strong>«Αφαίρεση ελέγχου εκκρεμών συναλλαγών και ξεκλείδωμα παραγγελίας;»</strong>. Πάτα <strong>«Ναι»</strong> για να ξεκλειδώσει η παραγγελία.
          </InfoBox>
        </>
      )}
