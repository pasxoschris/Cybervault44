    ...
    <TutorialLayout title="Μεταφορά Παραγγελίας" subtitle="Μεταφορά παραγγελίας από σερβιτόρο σε σερβιτόρο">
      ...
      <InfoBox icon="🔁" title="Τι κάνω σε περίπτωση χαμένης μεταφοράς" variant="warning">
        ...
        <ul className="list-disc pl-5 mt-2 space-y-1.5">
          ...
          <li>Ενημέρωσε την <strong>Spotlight</strong> (ή την CyberVault) ώστε να <strong>ακυρώσει τις χαμένες μεταφορές</strong> από το σύστημα και να καθαρίσει το χρονολόγιο.</li>
          <li>Μην προσπαθείς να μεταφέρεις ξανά την ίδια παραγγελία πριν ακυρωθεί η προηγούμενη — περίμενε επιβεβαίωση ακύρωσης.</li>
        </ul>
      </InfoBox>
