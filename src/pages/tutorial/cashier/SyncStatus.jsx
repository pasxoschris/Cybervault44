...
export default function SyncStatusCashier() {
  return (
    <CashierTutorialLayout
      title="Δείκτης Σύνδεσης & Συγχρονισμού"
      subtitle="Πώς να επιβεβαιώσεις ότι το ταμείο είναι συνδεδεμένο και τα δεδομένα συγχρονίζονται"
    >
      <StepCard number="1" title="Πού βρίσκεται ο δείκτης">
        <p>
          Στο <strong>κάτω μέρος της οθόνης</strong> του SpotlightPOS (Cashier Mode) εμφανίζεται ένας δείκτης που δείχνει την κατάσταση σύνδεσης και συγχρονισμού με το Cloud.
        </p>
      </StepCard>
