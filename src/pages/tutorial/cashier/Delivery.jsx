  ...
  return (
    <CashierTutorialLayout title="Παραγγελία Delivery" subtitle="Delivery tag, στοιχεία πελάτη & διανομείς">
      ...
      <InfoBox icon="🛵" title="Πότε χρησιμοποιείται" variant="info">
        Όταν πάρεις παραγγελία τηλεφωνικά ή μέσω πλατφόρμας (E-Food, Wolt, Box), μπορείς να τη δημιουργήσεις στο Cashier mode, να καταχωρήσεις τον πελάτη με αναζήτηση τηλεφώνου, και να την αναθέσεις σε διανομέα με ενεργή βάρδια.
      </InfoBox>

      {/* Delivery Tag */}
      <SectionTitle>1. Delivery Tag — Επιλογή Πλατφόρμας</SectionTitle>
      ...
      <StepCard number="1" title="Πού βρίσκεται το Delivery Tag">
        <p>
          ...
          Αυτό υποδηλώνει τον τρέχοντα πλατφόρμας στον οποίο θα σταλεί η παραγγελία.
        </p>
      </StepCard>

      <StepCard number="2" title="Αλλαγή πλατφόρμας">
        <p>
        ...
        <p className="mt-2">
          Επίλεξε τον πλατφόρμας που θέλεις. Το επιλεγμένο όνομα εμφανίζεται στο κουμπί με μπλε χρώμα και η παραγγελία θα σταλεί στο αντίστοιχο κανάλι.
        </p>
      </StepCard>

      <InfoBox icon="💡" title="Σημείωση" variant="purple">
        Το Delivery Tag καθορίζει πού θα καταχωρηθεί η παραγγελία. Αν πάρεις τηλεφωνική παραγγελία, μπορείς να αφήσεις το E-Food ή να επιλέξεις τον αντίστοιχο πλατφόρμας.
      </InfoBox>
