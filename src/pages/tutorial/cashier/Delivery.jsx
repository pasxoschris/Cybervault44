    ...
    <CashierTutorialLayout title="Παραγγελία Delivery" subtitle="Delivery tag, στοιχεία πελάτη & διανομείς">
      ...
      <StepCard number="1" title="Πού βρίσκεται το Delivery Tag">
        <p>
          ...
          Αυτό υποδηλώνει την τρέχουσα πλατφόρμα στην οποία θα σταλεί η παραγγελία.
        </p>
      </StepCard>
      ...
      <StepCard number="2" title="Αλλαγή πλατφόρμας">
        ...
        <p className="mt-2">
          Επίλεξε την πλατφόρμα που θέλεις. Το επιλεγμένο όνομα εμφανίζεται στο κουμπί με μπλε χρώμα και η παραγγελία θα σταλεί στο αντίστοιχο κανάλι.
        </p>
      </StepCard>

      <InfoBox icon="💡" title="Σημείωση" variant="purple">
        Το Delivery Tag καθορίζει πού θα καταχωρηθεί η παραγγελία. Αν πάρεις τηλεφωνική παραγγελία, μπορείς να αφήσεις το E-Food ή να επιλέξεις την αντίστοιχη πλατφόρμα.
      </InfoBox>
