  ...
  return (
    <CashierTutorialLayout title="Αρχική Οθόνη" subtitle="Η κεντρική οθόνη του Cashier Mode στο iPad">
      ...
      <StepCard number="1" title="Μενού & Αναζήτηση">
        <p>Στα αριστερά βρίσκεται το <strong>μενού (hamburger)</strong> και η <strong>μπάρα αναζήτησης</strong> με placeholder «Όνομα προϊόντος». Πληκτρολόγησε το όνομα του προϊόντος για να το βρεις γρήγορα χωρίς να περιηγηθείς στις κατηγορίες.</p>
      </StepCard>
