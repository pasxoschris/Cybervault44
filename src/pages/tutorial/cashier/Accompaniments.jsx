  ...
  return (
    <CashierTutorialLayout title="Συνοδευτικά Προϊόντος" subtitle="Προσθήκη συνοδευτικών, σειράς σερβιρίσματος, τιμοκαταλόγου και σχολίων">
      <InfoBox icon="✏️" title="Τι θα μάθεις" variant="purple">
        <p>Πατώντας το <strong>μολύβι</strong> πάνω δεξιά σε κάθε προϊόν, ανοίγει ένα παράθυρο όπου προσθέτεις <strong>συνοδευτικά</strong> (π.χ. ζάχαρη, γάλα, πάγο), <strong>τιμοκατάλογο</strong> και <strong>σχόλια</strong> πριν το προσθέσεις στην παραγγελία.</p>
      </InfoBox>
      ...
      <SectionTitle>4. Τιμοκατάλογος</SectionTitle>
      ...
      <SectionTitle>5. Σχόλια</SectionTitle>
      ...
      <InfoBox icon="💡" title="Συνοπτικά" variant="info">
        <p><strong>Μολύβι → Συνοδευτικά → Τιμοκατάλογος → Σχόλια → ✓</strong>. Αν δεν χρειάζεσαι παραμετροποίηση, πάτα απλά την κάρτα (όχι το μολύβι) για να προσθέσεις το προϊόν απευθείας.</p>
      </InfoBox>
