...
const MODULES = [
  ...
  },
  {
    ...
    desc: 'Διαχειριστικό: ρυθμίσεις καταστήματος, δημιουργία χρηστών, δημιουργία καταλόγου/συνοδευτικών, πλάνο/τραπέζια καταστήματος, ρύθμιση συσκευών (εκτυπωτές, pda, POS) και δικαιωμάτων χρηστών, ενεργοποίηση λειτουργιών ανά συσκευή.',
