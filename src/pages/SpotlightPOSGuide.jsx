...
const MODULES = [
  ...
  },
  {
    ...
    desc: 'Εκπαίδευση maitre service: διαχείριση τραπεζιών, κατανομή σερβιτόρων, οργάνωση, υποδοχή πελατών, ροή παραγγελιών ανά σερβιτόρο.',
  ...
  },
  {
    ...
    points: ['Δημιουργία χρηστών & εγγραφή POS', 'Δικαιώματα & ενεργοποίηση λειτουργιών', 'Ρυθμίσεις καταστήματος'],
  },
];
