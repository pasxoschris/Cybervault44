...
const MODULES = [
  {
    icon: Utensils,
    title: 'Service Mode',
    desc: 'Εκπαίδευση σερβιτόρων: δημιουργία & επεξεργασία παραγγελίας, ακυρώσεις, εκπτώσεις, πληρωμές, έκδοση τιμολογίου, μεταφορά & συγχώνευση παραγγελιών, έναρξη/κλείσιμο βάρδιας.',
    points: ['Νέα & επεξεργασία παραγγελίας', 'Ακύρωση προϊόντος / παραγγελίας / απόδειξης', 'Έκδοση τιμολογίου', 'Παραγγελίες & ανάλυση βάρδιας'],
  },
  {
    icon: Calculator,
    title: 'Cashier Mode',
    desc: 'Εκπαίδευση ταμιά: αρχική οθόνη ταμείου, συνοδευτικά προϊόντα, πληρωμές & split payments, έκδοση τιμολογίου, παραγγελία delivery, κλείσιμο βάρδιας.',
    points: ['Πληρωμές & split payments', 'Παραγγελία delivery', 'Δείκτης σύνδεσης & συγχρονισμού', 'Κλείσιμο βάρδιας'],
  },
  {
    icon: ConciergeBell,
    title: 'Maitre Service',
    desc: 'Εκπαίδευση σερβιτόρων σε λειτουργία κεντρικού ταμείου (maitre service): διαχείριση τραπεζιών, κατανομή σερβιτόρων, οργάνωση, υποδοχή πελατών, ροή παραγγελιών ανά σερβιτόρο.',
    points: ['Διαχείριση τραπεζιών', 'Κατανομή σερβιτόρων', 'Υποδοχή & οργάνωση'],
  },
  {
    icon: Users,
    title: 'Maitre Mode',
    desc: 'Εκπαίδευση κεντρικού ταμείου (maitre mode): εποπτεία λειτουργίας, μετακίνηση/συγχώνευση τραπεζιών, ελέγχος ροής, συνολική εικόνα παραγγελιών & βάρδιας.',
    points: ['Εποπτεία παραγγελιών', 'Μετακίνηση & συγχώνευση τραπεζιών', 'Έλεγχος ροής'],
  },
  {
    icon: MonitorCog,
    title: 'Διαχειριστικό/Secure',
    desc: 'Εκπαίδευση Διαχειριστών: ρυθμίσεις καταστήματος, δημιουργία χρηστών, δημιουργία καταλόγου/συνοδευτικών, πλάνο/τραπέζια καταστήματος, ρύθμιση συσκευών (εκτυπωτές, pda, POS) και δικαιωμάτων χρηστών, ενεργοποίηση λειτουργιών ανά συσκευή.',
    points: ['Δημιουργία χρηστών & εγγραφή συσκευών χρηστών', 'Δικαιώματα & ενεργοποίηση λειτουργιών', 'Ρυθμίσεις καταστήματος'],
  },
];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="pt-24 pb-14 text-white" style={{ background: "linear-gradient(135deg, #6a2b9e 0%, #b32483 100%)" }}>
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-base md:text-lg text-white/80 max-w-2xl leading-relaxed" style={{ fontFamily: 'Inter, sans-serif' }}>
            Ολοκληρωμένο εκπαιδευτικό υλικό για το SpotlightPOS. Μαθήματα ανά ρόλο, βήματα, σενάρια και AI assistant.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-12">
        <h2 className="text-2xl font-bold text-gray-900 mb-3" style={{ fontFamily: 'Inter, sans-serif' }}>Τι είναι το Spotlight POS (SpotilightPOS)</h2>
        <p className="text-gray-600 leading-relaxed" style={{ fontFamily: 'Inter, sans-serif' }}>
          Το <strong>Spotlight POS (SpotlightPOS)</strong> είναι σύστημα διαχείρισης παραγγελιών για εστιατόρια, καφέ, μπαρ και ξενοδοχεία.
          <br />
          ...
          <br />
          Εκτός από την εκπαίδευση χρηστών, η <strong>CyberVault</strong> παρέχει τεχνική υποστήριξη για εγκαταστάσεις Spotlight POS.
        ...
        <div className="grid sm:grid-cols-3 gap-4 mt-6">
          {[
            ...
            { icon: ShieldCheck, t: 'Official Support', d: 'SpotlightPOS συνεργάτης' },
            { icon: GraduationCap, t: 'Ανά ρόλο', d: 'Service · Maitre · Cashier · Διαχειριστικό' },
          ].map(f => (
